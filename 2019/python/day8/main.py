...
def render_image(img_data, width, height):
...
def run():
    ...
    part_1(img_data)
    render_image(img_data, 25, 6)

def run_tests():
    img_data = [int(c) for c in '123456789012']
    layers = count_values(img_data, 3*2)
    render_image([int(c) for c in '0222112222120000'], 2, 2)
    ...
    layer4 = "00212002"
    layer5 = "20120002"
    img_data = [l for l in [layer1, layer2, layer3, layer4, layer5]]
